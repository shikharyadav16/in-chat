...
export default function OtpVerification({ setOpen, open, email, setIsAuthenticated }) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const res = await fetch("https://1aa0-2409-40e3-104c-4834-5850-2cb6-765d-cc6.ngrok-free.app/verify-otp", {
